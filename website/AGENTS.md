...
> with CI) carry over. See `.kit/stack-choice.md` for mapping guidance.
...
| Doc | Read when |
|-----|-----------|
| `.kit/getting-started.md` | Starting a new website project — guided workflow from idea to setup |
| `.kit/stack-choice.md` | Choosing between vanilla, React, Astro, Next.js, or other frameworks |
| `.kit/project-structure.md` | Organizing files for static, SPA, or server-rendered sites |
| `.kit/design-and-styling.md` | Styling approach, Tailwind CSS, responsive design, accessibility |
| `.kit/security.md` | Security essentials — secrets, input validation, dependencies |
| `.kit/hosting-static.md` | Deploying static sites (GitHub Pages, Vercel, Netlify, Cloudflare Pages) |
...
3. **No inline secrets.** API keys, tokens, and credentials go in `.env`. See `.kit/security.md`.
...
See `.kit/stack-choice.md` for when Astro, Next.js, or another framework is the better call.
