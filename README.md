...
│   ├── SESSION_SUMMARY.md       # Session handoff (auto-generated by pre-compact hook)
...
| `bash cli/propagate.sh` | Update downstream projects that use the kit |
...
|-------|------------|-------|
| Claude Code | `AGENTS.md` + `CLAUDE.md` | Full — `.claude/hooks/` (6 lifecycle events) |
